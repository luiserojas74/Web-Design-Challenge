## About
   - This is the personal project for unit 11(Web) of [Data Visualization and Analytics](https://bootcamp.umn.edu/data/landing%20full/)
...
<img src="./Images/app.png " width="600" height="400">
   ...
   - The web-link for the app of this project is [here](https://luiserojas74.github.io/Web-visualization-dashboard/).
...
## Project
   https://luiserojas74.github.io/Web-Visualization-Dashboard/

## Some observations
   - From the weather data for 538 cities, we conclude that temperature is peaked around 80 Fahrenheit near the equator from -20 to 30 degrees of Latitude. It continually drops to 30 Fahrenheit(even lower for several cities) in the region of 40 to 80 degree of latitude.
